"""Think tool for agent reflection during RAG analysis.

This tool provides a structured way for agents to pause and reflect on their
RAG analysis progress, following the pattern from Anthropic's "Claude Think Tool":
...
from shared.emitter import emit_thinking
...
def think_tool(thought: str) -> str:
    ...
    return "Thought recorded. Continue with your analysis based on this reflection."
